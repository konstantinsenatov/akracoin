...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  ...
  var circlePosition1 = gsap.timeline();
  circlePosition1.fromTo('.circle1', 1, {
  ...
  var circlePosition2 = gsap.timeline();
  circlePosition2.fromTo('.circle2', 1, {
  ...
  var circlePosition3 = gsap.timeline();
  circlePosition3.fromTo('.circle3', 1, {
  ...
  var circlePosition4 = gsap.timeline();
  circlePosition4.fromTo('.circle4', 1, {
  ...
  var circlePosition5 = gsap.timeline();
  circlePosition5.fromTo('.circle5', 1, {
  ...
  var circlePosition6 = gsap.timeline();
  circlePosition6.fromTo('.circle6', 1, {
  ...
  var circlePosition7 = gsap.timeline();
  circlePosition7.fromTo('.circle7', 1, {
